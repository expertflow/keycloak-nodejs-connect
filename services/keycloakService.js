      ...
      try {
        ...
        monitoringInterval = setInterval( async () => {
          ...
          try {
            ...
            const events = await fetchAdminEvents( keycloakConfig[ "auth-server-url" ], keycloakConfig[ "realm" ], keycloakAdminToken );
...
let fetchAdminEvents = ( baseUrl, realm, keycloakAdminToken ) => {
