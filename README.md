...
It takes 5 arguments: 
 ...
 ##### Example of SSO Finesse Auth:
        ...
        authenticateFinesse('johndoe', '', `https://${finesse_server_url}:${port}`, '1207', 'eyJhbGciOiJkaXIiLCJjdHkiOiJKV1QiLCJlbmMiOiJBMTI4Q0JDLUhTMjU2In0..oPk0ttAA')
        
 ##### Example of non SSO Finesse Auth:
      
      authenticateFinesse('johndoe', '12345', `https://${finesse_server_url}:${port}`, '1207', '')
